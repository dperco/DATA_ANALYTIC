...
BEFORE INSERT ON argentina_campeonato_masc_teams2_2023
FOR EACH ROW
BEGIN
...
AFTER UPDATE ON argentina_campeonato_masc_teams2_2023
FOR EACH ROW
BEGIN
    INSERT INTO log_equipos (usuario, fecha, hora, accion, descripcion)
...
BEFORE INSERT ON argentina_campeonato_masc_player_2023
FOR EACH ROW
BEGIN
...
AFTER UPDATE ON argentina_campeonato_masc_player_2023
FOR EACH ROW
BEGIN
    INSERT INTO log_jugadores (usuario, fecha, hora, accion, descripcion)
