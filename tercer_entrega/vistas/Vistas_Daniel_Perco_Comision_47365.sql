...
SELECT DISTINCT home_team_name FROM argentina_campeonato_masc_matches_2023;


#### vista 3 Seleccionar los jugadores mayores de 25 años
CREATE VIEW vista_jugadores_mayores_25 AS
SELECT * FROM argentina_campeonato_masc_player_2023
WHERE age > '25';
...
FROM argentina_campeonato_masc_matches_2023 m
JOIN argentina_campeonato_masc_player_2023 p
